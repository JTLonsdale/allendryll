...
const WILLOWMERE = {
  ...
  tiles: [
    ...
    [TR, FC, WL, DR, WL, _, SN, _, TB, TB, TB, TB, _, SN, WL, DR, WL, FC, TR, TR],
    ...
    [TR, FC, WL, DR, WL, _, _, _, _, _, _, _, _, _, _, GD, GD, FC, TR, TR],
...
const STORMHAVEN = {
  ...
  tiles: [
    ...
    [WL, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, WL],
    [WL, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, WL],
    [WL, _, _, _, SN, _, _, _, _, _, _, _, _, _, _, _, _, SN, _, _, _, WL],
...
const CRYSTALVALE = {
  ...
  tiles: [
    ...
    [WL, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, WL],
    [WL, _, _, SN, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, SN, _, _, WL],
    [WL, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, WL],
...
const FERNHOLLOW = {
  ...
  tiles: [
    ...
    [TR, _, _, _, _, _, _, TT, _, _, _, _, _, _, _, _, _, _, _, TR],
    [TR, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, TR],
    [TR, TR, TR, TR, TR, EX, EX, EX, EX, EX, EX, EX, EX, EX, EX, TR, TR, TR, TR, TR],
    [TR, TR, TR, TR, TR, EX, EX, EX, EX, EX, EX, EX, EX, EX, EX, TR, TR, TR, TR, TR],
  ],
...
const LAKEPORT = {
  ...
  tiles: [
    ...
    [_, _, _, _, _, WL, DR, WL, _, _, SN, _, _, WL, DR, WL, _, _, _, _, _, _],
